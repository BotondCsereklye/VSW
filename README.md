...
- Fuer Windows ist die Launcher-App jetzt der empfohlene Startweg, weil sie Python 3.12+ erkennt, Setup anstosst und Frontend plus Backend gemeinsam startet.
...
- Browser-Extension als reine Link-Capture-Erweiterung zum lokalen Backend
...
- Browser-Extension, die nur geklickte Links oder aktive Tabs an das lokale Backend fuer defensive Folge-Scans uebergibt
